...
function(Lat, Long, Product)
{
  ...
  getdates.xml <- paste('
<soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:mod="https://modis.ornl.gov/MODIS_soapservice">
   <soapenv:Header/>
                         <soapenv:Body>
  ...
  curlPerform(url = paste0(daacmodis, "/cgi-bin/MODIS/soapservice/MODIS_soapservice.pl"),
